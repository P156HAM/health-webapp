...
>(({ className, children, ...props }, ref) => (
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            onPointerDownOutside={(e) => e.preventDefault()} // Prevents dialog from closing on outside click
            onEscapeKeyDown={(e) => e.preventDefault()} // Prevents dialog from closing on escape key press
            {...props}
        >
            {children}
        </DialogPrimitive.Content>
